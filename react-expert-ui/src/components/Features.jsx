    ...
    <section className="section">
      <div className="container">
        ...
        <div className="row g-4 align-items-stretch mb-4">
          <div className="col-lg-4">
            <div className="feature-tile h-100">
              <p className="mb-2 fw-semibold">Available Session Lengths</p>
              <div className="mb-3">
              ...
              <img className="img-fluid rounded-20 img-shadow" src="https://placehold.co/640x200/EEE/000?text=1.5hr+2hr+2.5hr+3hr" alt="session lengths" />
            </div>
          </div>
          <div className="col-lg-4">
            <div className="feature-tile h-100 d-flex align-items-center justify-content-between">
              ...
              <button className="btn btn-dark btn-sm px-3">Connect</button>
            </div>
          </div>
          <div className="col-lg-4">
            <div className="feature-tile h-100 d-flex align-items-center justify-content-center">
              <div className="px-3 py-2 rounded-20 bg-dark text-white text-center w-100">
        ...
        <div className="row g-4">
          <div className="col-lg-4">
            <h5>Offer multiple call durations</h5>
