      ...
      <div className="container">
        ...
        <div className="row g-4 align-items-stretch mb-4">
          ...
          <div className="col-lg-4">
            <div className="feature-tile h-100 d-flex align-items-center justify-content-center">
              <div className="px-3 py-3 bg-light text-dark text-center w-100" style={{borderRadius:8}}>
        ...
        <div className="row g-4 align-items-start">
          ...
          <div className="col-lg-4">
            ...
            <p className="text-muted-90 small mb-0" style={{fontSize:'0.95rem'}}>Let consumers know that you’re donating 5–100% of your proceeds to the charity of your choice</p>
          </div>
        </div>
      </div>
    </section>
